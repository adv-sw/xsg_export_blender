...
class Export_Material:
	...
	def Write(exp, mtl):
		...
		if mtl.node_tree == None:
            ...
            # Used to indicate we've written <material [attribs]> & are now ready to begin writing parts. Required so we don't try to close element open tag more than once.
			mtl_open_complete = False
